          ...
          <div className="col-span-12 lg:col-span-5 flex flex-col justify-center space-y-6">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-4 p-4" >
              <input
                ...
                className="flex-grow rounded-lg  py-3 border-2 border-gray-300 focus:border-gray-900 transition duration-300 p-3"
                required
              />
              <button
                type="submit"
                className="bg-gray-900 text-white py-3 rounded-lg hover:bg-gray-700 transition duration-300 p-3"
              >
                Get Started
              </button>
            </form>
