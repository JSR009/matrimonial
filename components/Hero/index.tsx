      ...
      <div className="mx-auto max-w-7xl pt-16 md:pt-20">
        ...
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-12 lg:col-span-5 flex flex-col justify-center space-y-6">
            ...
            {/* Email Form */}
            <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-4 py-4 p-2" >
              <input
                value={email}
                onChange={(e) => setEmail(e.target.value)}
                type="email"
                placeholder="Enter your email"
                className="flex-grow rounded-lg px-4 py-3 border-2 border-gray-300 focus:border-gray-900 transition duration-300 p-4"
                required
              />
              <button
                type="submit"
                className="bg-gray-900 text-white px-6 py-3 rounded-lg hover:bg-gray-700 transition duration-300 p-4"
              >
                Get Started
              </button>
            </form>
